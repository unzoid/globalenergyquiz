    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          'focus:outline-none',
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent after:data-[focus]:ring-2 after:data-[focus]:ring-indigo-500',
          // Disabled state
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              'outline-none data-[focus]:bg-indigo-500 data-[focus]:text-white',
              // Forced colors mode
